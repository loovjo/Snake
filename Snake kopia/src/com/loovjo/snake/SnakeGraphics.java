...
public class SnakeGraphics extends JPanel implements Runnable, KeyListener,
	...
	public static String title = "xXx_#SnAkEnEMiTeYoLo_DANK_IN_THE_BANK_xXx";
	...
	public void paint(Graphics g) {
		...
		for (int x = 0; x < s.BOARD_WIDTH; x++) {
			for (int y = 0; y < s.BOARD_WIDTH; y++) {
				...
				g.fillRect((int)(x * sqW), (int)(y * sqH), (int)sqW, (int)sqH);
				g.setColor(Color.black);
				g.drawRect((int)(x * sqW), (int)(y * sqH), (int)sqW, (int)sqH);
			}
		}
	}
